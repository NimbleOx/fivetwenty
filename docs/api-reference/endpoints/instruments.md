...
## candles
```python
instruments.candles(instrument: str, price: str = "M", granularity: str = "S5", count: int | None = None, from_time: str | None = None, to_time: str | None = None, smooth: bool = False, include_first: bool = True, daily_alignment: int = 17, alignment_timezone: str = "America/New_York", weekly_alignment: str = "Friday") -> dict[str, Any]
```
