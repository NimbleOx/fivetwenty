...
| `alias` | str \| None | ➖ | Client-assigned alias for the account (optional) |
...
| `guaranteed_stop_loss_order_parameters` | [GuaranteedStopLossOrderParameters](#guaranteedstoplossorderparameters) \| None | ➖ | GSL order parameters (optional) |
...
| `guaranteed_stop_loss_order_mutability` | [GuaranteedStopLossOrderMutability](#guaranteedstoplossordermutability) \| None | ➖ | GSL order mutability (deprecated but may still be present) |
| `resettable_pl_time` | [DateTime](system-models.md#type-aliases) \| None |➖ | Time when P&L was last reset |
| `margin_rate` | Decimal \| None | ➖ | Account margin rate |
...
| `margin_call_enter_time` | [DateTime](system-models.md#type-aliases) \| None |➖ | Margin call entry time (conditional) |
| `margin_call_extension_count` | int \| None | ➖ | Number of margin call extensions |
| `last_margin_call_extension_time` | [DateTime](system-models.md#type-aliases) \| None |➖ | Last margin call extension time |
...
|-------|------|----------|-------------|
| `id` | [AccountID](system-models.md#type-aliases) |✅ | Account's identifier |
| `mt4_account_id` | int \| None | ➖ | Associated MT4 Account ID (only present if account is an MT4 account) |
...
| `transactions` | list[[Transaction](transaction-models.md#transaction)] | ➖ | Parsed transaction records, preserving concrete transaction subtype fields |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `unrealized_pl` | [AccountUnits](system-models.md#type-aliases) \| None | ➖ | Total unrealized profit/loss from all open trades |
| `nav` | [AccountUnits](system-models.md#type-aliases) \| None | ➖ | Net Asset Value (balance + unrealized P&L) |
| `margin_used` | [AccountUnits](system-models.md#type-aliases) \| None | ➖ | Currently used margin in account currency |
| `margin_available` | [AccountUnits](system-models.md#type-aliases) \| None | ➖ | Available margin for opening new positions |
| `position_value` | [AccountUnits](system-models.md#type-aliases) \| None | ➖ | Total value of all open positions in home currency |
| `margin_closeout_unrealized_pl` | [AccountUnits](system-models.md#type-aliases) \| None | ➖ | Margin closeout unrealized P&L |
| `margin_closeout_nav` | [AccountUnits](system-models.md#type-aliases) \| None | ➖ | Margin closeout NAV |
| `margin_closeout_margin_used` | [AccountUnits](system-models.md#type-aliases) \| None | ➖ | Margin closeout margin used |
| `margin_closeout_percent` | Decimal \| None | ➖ | Margin closeout percentage (≥1.0 = closeout) |
| `margin_closeout_position_value` | Decimal \| None | ➖ | Margin closeout position value |
| `withdrawal_limit` | [AccountUnits](system-models.md#type-aliases) \| None | ➖ | Current withdrawal limit |
| `margin_call_margin_used` | [AccountUnits](system-models.md#type-aliases) \| None | ➖ | Margin call margin used |
| `margin_call_percent` | Decimal \| None | ➖ | Margin call percentage (≥1.0 = margin call) |
| `balance` | [AccountUnits](system-models.md#type-aliases) \| None | ➖ | Current account balance in account currency |
| `pl` | [AccountUnits](system-models.md#type-aliases) \| None | ➖ | Total lifetime profit/loss |
| `resettable_pl` | [AccountUnits](system-models.md#type-aliases) \| None | ➖ | Realized profit/loss since last reset |
| `financing` | [AccountUnits](system-models.md#type-aliases) \| None | ➖ | Total lifetime financing |
| `commission` | [AccountUnits](system-models.md#type-aliases) \| None | ➖ | Total lifetime commission |
| `dividend_adjustment` | [AccountUnits](system-models.md#type-aliases) \| None | ➖ | Total dividend adjustments |
| `guaranteed_execution_fees` | [AccountUnits](system-models.md#type-aliases) \| None | ➖ | Total guaranteed execution fees |
| `margin_call_enter_time` | [DateTime](system-models.md#type-aliases) \| None |➖ | Margin call entry time (conditional) |
| `margin_call_extension_count` | int \| None | ➖ | Number of margin call extensions |
| `last_margin_call_extension_time` | [DateTime](system-models.md#type-aliases) \| None |➖ | Last margin call extension time |
