...
| Status | File Path | Category | Code Blocks |
|--------|-----------|----------|-------------|
| `[x]` | `tutorials/getting-started/installation.md` | Tutorials | 5 |
| `[x]` | `tutorials/getting-started/authentication.md` | Tutorials | 15 |
| `[x]` | `tutorials/getting-started/first-trade.md` | Tutorials | 6 |
| `[x]` | `tutorials/basic-trading/foundation.md` | Tutorials | 6 |
| `[x]` | `tutorials/basic-trading/market-data.md` | Tutorials | 5 |
...
| `[ ]` | `guides/understanding/environments.md` | Guides | 11 |
| `[ ]` | `guides/understanding/sdk-architecture.md` | Guides | 35 |
| `[ ]` | `guides/trading-concepts/forex-trading-concepts.md` | Guides | 38 |
| `[ ]` | `guides/trading-concepts/order-types.md` | Guides | 11 |
| `[ ]` | `guides/trading-concepts/streaming.md` | Guides | 2 |
| `[ ]` | `guides/practical-solutions/close-positions.md` | Guides | 5 |
| `[ ]` | `guides/practical-solutions/handle-connection-failures.md` | Guides | 21 |
| `[ ]` | `guides/practical-solutions/implement-stop-loss-strategies.md` | Guides | 12 |
| `[ ]` | `guides/practical-solutions/manage-orders-effectively.md` | Guides | 25 |
| `[ ]` | `guides/practical-solutions/multi-account-configuration.md` | Guides | 11 |
| `[ ]` | `guides/practical-solutions/setup-live-trading.md` | Guides | 9 |
| `[ ]` | `guides/optimization/connection-optimization.md` | Guides | 2 |
| `[ ]` | `guides/optimization/latency-optimization.md` | Guides | 5 |
| `[ ]` | `guides/optimization/memory-cpu-optimization.md` | Guides | 9 |
