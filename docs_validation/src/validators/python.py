    ...
    def _validate_python_file(self, content: str, file_path: Path) -> list[ValidationIssue]:
        ...
        try:
            ...
            issues.append(ValidationIssue(
                ...
                context=self._get_line_context(content, e.lineno) if e.lineno else None,
    ...
    def _validate_python_code_blocks(self, content: str, file_path: Path) -> list[ValidationIssue]:
        ...
        for block_start_line, code_block in code_blocks:
            ...
            try:
                ...
                issues.append(ValidationIssue(
                    message=f"Failed to parse Python code block: {e}",
                    file_path=file_path,
                    line=block_start_line,
                    severity=IssueSeverity.WARNING,
                    rule_id="python_code_block_parse",
                    suggestion="Check the Python code block for syntax issues"
                ))
